...
class CoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should not be able to access the my_courses if not signed in" do
    get my_courses_path
    assert_response :redirect
    assert_equal flash[:alert], "You need to sign in or sign up before continuing."
  end

  test "should be able to access the my_courses if signed in" do
  ...
  test "should be able to process payment_notification" do
